...
# If you remove the hash_email variable the model should work again. That said it was my efforto to not let other users reset passwords.
class User(models.Model):
    name = models.CharField(max_length=255)
    email = models.EmailField(max_length=255, unique=True, blank=False)
    password = models.CharField(max_length=255, blank=False)
    hash_email = models.CharField(max_length=255, blank=False)
